...
import AnimatedHeader from '../TitleText/title-text';
...
const Form: React.FC<FormProps> = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs.send(process.env.NEXT_PUBLIC_SERVICE_ID??'', process.env.NEXT_PUBLIC_TEMPLATE_ID??'', formData, process.env.NEXT_PUBLIC_USER_ID??'')
      .then((response) => {
