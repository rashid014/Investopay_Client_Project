...
const IconCard: React.FC<IconCardProps> = ({ icon, title, description }) => {
  return (
    <div
      className="flex flex-col items-center p-4 rounded-md mx-auto text-center mb-4"
      style={{
        width: '220px',
...
const LoanContainer: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-center md:h-1/4 lg:h-1/3 xl:h-1/2 mt-10 -4">
        <h2 className="text-gray-50 text-3xl font-semibold mt-4">
          Loans
        </h2>
      </div>
